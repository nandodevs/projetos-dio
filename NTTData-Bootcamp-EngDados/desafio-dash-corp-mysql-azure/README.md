...
Foi sugerido a criação de uma instância no Azure para a criação e inserção de dados no banco, através do portal do Azure foram realizadas as etapas de criação do banco, do servidor e realizada a conexão com o Power Bi.
...
Relatório desenvolvido por Sisnando Junior .
